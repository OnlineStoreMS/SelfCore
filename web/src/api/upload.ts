...
export async function uploadImage(file: File, subdir = 'do'): Promise<{ url: string; fileName: string }> {
...
export async function createPhotoUploadSession(subdir = 'do'): Promise<PhotoUploadSession> {
